...
<body>
    <div class="col-md-4 col-md-offset-4" id="login">
        <section id="inner-wrapper" class="login">
            <article>
                <form action="{{route('update_customer_route',$customer->id)}}" method="POST">
                    @if(Session::has('fail'))
                        <script>
                            toastr.options = {
                                "progressBar" : true,
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user"> </i></span>
                            <input type="text" value="{{$customer->last_name}}" name="last_name" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{$customer->identifier}}" name="identifier" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <a class="btn btn-danger" href="{{route('customer_route')}}">Cancel</a>
