	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>CRUD<b> Categories</b></h2>
					</div>
                        <form action="{{route('category_filter_route')}}" method="POST">
                            @csrf
						...
						<a href="#addEmployeeModal" class="btn btn-success" style="height: 33px; margin-left: 114px;" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Categories</span></a>
			...
			<table class="table table-striped table-hover">
				<thead>
					<tr>
						<th style="width: 785px">ID Category</th>
						<th style="width: 785px" >Category Name</th>
				...
				<tbody>
					...
					<tr>
                        ...
                        <td>
                            <a href="{{route('edit_category_route',$category->id)}}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="#deleteCategory{{$category->id}}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>

					</tr>
                        @include('modalDeleteCategory')
                    @endforeach
				</tbody>
			</table>
			<div class="clearfix">
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
            <form action="{{route('store_category_route')}}"  method="POST">
                @if(Session::has('fail'))
                    <script>
                        toastr.options = {
                            "progressBar" : true,
