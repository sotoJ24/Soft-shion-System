			...
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						...
						<a href="#addEmployeeModal" class="btn btn-success" style="height: 33px; margin-left: 114px;" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Customers</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
                        ...
                        <td>
                            <a href="{{route('edit_customer_route',$customer->id)}}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="#deleteEmployeeCustomer{{$customer->id}}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
            <form action="{{route('store_customer_route')}}"  method="POST">
                @csrf
