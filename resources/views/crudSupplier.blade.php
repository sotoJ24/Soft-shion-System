	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>CRUD<b> Supplier</b></h2>
					</div>
                        <form action="{{route('supplier_filter_route')}}" method="POST">
                            @csrf
						...
						<a href="#addEmployeeModal" class="btn btn-success" style="height: 33px; margin-left: 114px;" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Supplier</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
                        ...
                        <td>
                            <a href="{{route('edit_supplier_route',$supplier->id)}}" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="#deleteSupplierModal{{$supplier->id}}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
						</td>

					</tr>
                        @include('modaldeleteSupplier')
                    @endforeach
				</tbody>
			</table>
			<div class="clearfix">
...
<div id="addEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
            <form action="{{route('store_supplier_route')}}"  method="POST">
                @if(Session::has('fail'))
                    <script>
                        toastr.options = {
                            "progressBar" : true,
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="number" min="0" class="form-control" name="phone_number" required>
					</div>
                    <div class="form-group">
						<label>Email</label>
